...
`timescale 1 ps / 1 ps
module PD_PIO_mm_interconnect_0 (
	...
	wire  [103:0] cmd_mux_src_data;                                                   // cmd_mux:src_data -> pio_0_s1_agent:cp_data
	wire          cmd_mux_src_ready;                                                  // pio_0_s1_agent:cp_ready -> cmd_mux:src_ready
	wire    [2:0] cmd_mux_src_channel;                                                // cmd_mux:src_channel -> pio_0_s1_agent:cp_channel
	...
	wire  [104:0] pio_1_s1_agent_rf_source_data;                                      // pio_1_s1_agent:rf_source_data -> pio_1_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] pio_1_s1_agent_rsp_fifo_out_data;                                   // pio_1_s1_agent_rsp_fifo:out_data -> pio_1_s1_agent:rf_sink_data
	...
	wire  [103:0] cmd_mux_001_src_data;                                               // cmd_mux_001:src_data -> pio_1_s1_agent:cp_data
	wire          cmd_mux_001_src_ready;                                              // pio_1_s1_agent:cp_ready -> cmd_mux_001:src_ready
	wire    [2:0] cmd_mux_001_src_channel;                                            // cmd_mux_001:src_channel -> pio_1_s1_agent:cp_channel
	...
	wire  [104:0] pio_2_s1_agent_rf_source_data;                                      // pio_2_s1_agent:rf_source_data -> pio_2_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] pio_2_s1_agent_rsp_fifo_out_data;                                   // pio_2_s1_agent_rsp_fifo:out_data -> pio_2_s1_agent:rf_sink_data
	...
	wire          cmd_mux_002_src_valid;                                              // cmd_mux_002:src_valid -> pio_2_s1_agent:cp_valid
	wire  [103:0] cmd_mux_002_src_data;                                               // cmd_mux_002:src_data -> pio_2_s1_agent:cp_data
	wire          cmd_mux_002_src_ready;                                              // pio_2_s1_agent:cp_ready -> cmd_mux_002:src_ready
	wire    [2:0] cmd_mux_002_src_channel;                                            // cmd_mux_002:src_channel -> pio_2_s1_agent:cp_channel
	wire          cmd_mux_002_src_startofpacket;                                      // cmd_mux_002:src_startofpacket -> pio_2_s1_agent:cp_startofpacket
	wire          cmd_mux_002_src_endofpacket;                                        // cmd_mux_002:src_endofpacket -> pio_2_s1_agent:cp_endofpacket
	...
	wire  [103:0] pio_0_s1_agent_rp_data;                                             // pio_0_s1_agent:rp_data -> router_001:sink_data
	...
	wire  [103:0] pio_1_s1_agent_rp_data;                                             // pio_1_s1_agent:rp_data -> router_002:sink_data
	...
	wire          pio_2_s1_agent_rp_valid;                                            // pio_2_s1_agent:rp_valid -> router_003:sink_valid
	wire  [103:0] pio_2_s1_agent_rp_data;                                             // pio_2_s1_agent:rp_data -> router_003:sink_data
	wire          pio_2_s1_agent_rp_ready;                                            // router_003:sink_ready -> pio_2_s1_agent:rp_ready
	wire          pio_2_s1_agent_rp_startofpacket;                                    // pio_2_s1_agent:rp_startofpacket -> router_003:sink_startofpacket
	wire          pio_2_s1_agent_rp_endofpacket;                                      // pio_2_s1_agent:rp_endofpacket -> router_003:sink_endofpacket
	...
	wire          pio_2_s1_agent_rdata_fifo_src_valid;                                // pio_2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_002:in_0_valid
	wire   [33:0] pio_2_s1_agent_rdata_fifo_src_data;                                 // pio_2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_002:in_0_data
	wire          pio_2_s1_agent_rdata_fifo_src_ready;                                // avalon_st_adapter_002:in_0_ready -> pio_2_s1_agent:rdata_fifo_src_ready
	...
	PD_PIO_mm_interconnect_0_router router (
	...
	PD_PIO_mm_interconnect_0_router_001 router_001 (
	...
	PD_PIO_mm_interconnect_0_router_001 router_002 (
	...
	PD_PIO_mm_interconnect_0_router_001 router_003 (
	...
	PD_PIO_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_0_clk_clk),                                 //        clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset),       //  clk_reset.reset
	...
	PD_PIO_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_PIO_mm_interconnect_0_cmd_mux cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_PIO_mm_interconnect_0_cmd_mux cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_PIO_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_PIO_mm_interconnect_0_rsp_demux rsp_demux_001 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_PIO_mm_interconnect_0_rsp_demux rsp_demux_002 (
		.clk                (clk_0_clk_clk),                           //       clk.clk
		.reset              (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_PIO_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_0_clk_clk),                           //       clk.clk
		.reset               (pio_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	PD_PIO_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
